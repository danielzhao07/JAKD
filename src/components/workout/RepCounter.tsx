    ...
    return (
      <div className="text-center space-y-4">
        <div className="grid grid-cols-2 gap-4">
          {/* Left Arm */}
          <div className="bg-dark-800 p-4 border border-gray-700">
        ...
        <div>
          ...
          <div className="flex items-center justify-center gap-4">
            {editable && (
              <button
                onClick={onDecrement}
                className="w-10 h-10 bg-dark-700 border border-gray-600 flex items-center justify-center text-gray-300 hover:text-white hover:border-cyan-500 transition-all duration-200 transform hover:scale-110"
              >
                <Minus size={18} />
              </button>
            )}
