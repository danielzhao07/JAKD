      ...
      <Card className="space-y-5">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 bg-dark-700 border border-gray-600 text-white text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500"
          >
        ...
        <div>
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="flex-1 h-2 bg-dark-700 appearance-none cursor-pointer accent-cyan-500"
            />
