  ...
  return (
    <div>
      ...
      <select
        ...
        className="w-full bg-dark-700 border border-gray-600 px-4 py-2.5 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
      >
